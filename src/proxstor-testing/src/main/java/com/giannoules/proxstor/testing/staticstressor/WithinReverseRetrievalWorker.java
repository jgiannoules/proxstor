...
public class WithinReverseRetrievalWorker implements Runnable {
    ...
    public WithinReverseRetrievalWorker(ProxStorConnector conn, List<String> userIds, AtomicInteger counter) {
        this.conn = conn;
    ...
    public void run() {
        ...
        do {
            ...
            locations = conn.getLocationsWithinReverse(Integer.parseInt(locId));
