 ...
 */
public class KnowsStrengthResource {
    ...
    public KnowsStrengthResource(String userId, Integer strength) {
        this.userIdA = userId;
        this.strengthVal = strength;
        ProxStorDebug.println("KnowsStrengthResource constructor " + userId + " " + strength);
    }
